...
class icit_srdb_ui extends icit_srdb {
	...
	public function response( $name = '', $user = '', $pass = '', $host = '127.0.0.1', $charset = 'utf8', $collate = '' ) {
		...
		// Search replace details userfriendly by seb
                
		$search = isset( $_POST[ 'search' ] ) ? $_POST[ 'search' ] : preg_replace('/(.+)\.(.+)$/U','$1.dev',$_SERVER['SERVER_NAME']);
		$replace = isset( $_POST[ 'replace' ] ) ? $_POST[ 'replace' ] : $_SERVER['SERVER_NAME'];
